 ...
 * @param {Object} expenseData - The expense fields (title/description, amount, category, date).
 * @returns {Promise<Object>} The server response.
 */
export const createExpense = async (expenseData) => {
  // Map description to title and description as required by the backend schema
  const payload = {
