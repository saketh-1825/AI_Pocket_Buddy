...
function ExpenseSkeleton() {
  return (
    <div className="w-full overflow-hidden rounded-2xl border border-white/5 bg-[#1E293B]">
      <div className="overflow-x-auto">
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="border-b border-white/5 bg-[#0B1220]/40 text-xs font-semibold uppercase tracking-wider text-[#94A3B8]">
